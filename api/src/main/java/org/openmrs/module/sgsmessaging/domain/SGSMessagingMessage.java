 ...
 * @see MessageFactory
 */
public class SGSMessagingMessage extends BaseOpenmrsObject {
	
	protected SGSMessagingMessage() {
	}
	 ...
	 */
	public SGSMessagingMessage(String destination, String content) {
	 ...
	 * @return
	 */
	public SGSMessagingMessageStatus getMessageStatus() {
		return SGSMessagingMessageStatus.getStatusByNumber(this.getStatus());
	}
	
	/**
	 * @param status
	 */
	public void setMessageStatus(SGSMessagingMessageStatus status) {
