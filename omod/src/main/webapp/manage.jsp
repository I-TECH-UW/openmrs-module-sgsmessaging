	...
	jQuery(document).ready(function() {
		...
		jQuery("a#customExporter").click(function() {
			var selectedChk = '';
			 ...
			 window.location.href = "${pageContext.request.contextPath}/module/sgsmessaging/exportFile.form?exportType=CUSTOM&moduleId="+selectedChk;
			  }
	...
	<table cellpadding="2" cellspacing="0" width="100%">
		...
		<c:forEach var="message" items="${messages}" varStatus="status">
			<tr class='${status.index % 2 == 0 ? "evenRow" : "oddRow"}'>
				...
				<td>
				<a href="${pageContext.request.contextPath}/module/sgsmessaging/resend.form?messageId=${message.messageId}&resendType=SINGLE"><spring:message code="sgsmessaging.resend.single" /></a>
                &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/module/sgsmessaging/delete.form?messageId=${message.messageId}&deleteType=SINGLE"><spring:message code="sgsmessaging.delete.single" /></a>
				</td>
			</tr>
		</c:forEach>
	</table>
